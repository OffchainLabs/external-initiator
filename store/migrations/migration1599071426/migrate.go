...
func Migrate(tx *gorm.DB) error {
	...
	err = tx.AutoMigrate(&ArbSubscription{}).AddForeignKey("subscription_id", "subscriptions(id)", "CASCADE", "CASCADE").Error
	if err != nil {
...
func Rollback(tx *gorm.DB) error {
	return tx.DropTable("arb_subscriptions").Error
}