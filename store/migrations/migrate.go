...
import (
	...
	"github.com/smartcontractkit/external-initiator/store/migrations/migration1596019049"
...
func Migrate(db *gorm.DB) error {
	...
	migrations := []*gormigrate.Migration{
		...
		{
			ID:       "1596019049",
			Migrate:  migration1596019049.Migrate,
			Rollback: migration1596019049.Rollback,
		},
	}
